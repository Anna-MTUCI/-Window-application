...
class Window(QWidget): 
    ...
    def _create_shedule2_tab(self): 
        ...
        self.sub_gbox = QGroupBox("Препадователи")
    ...
    def _create_monday_table(self): 
        ...
        self.monday_table.setHorizontalHeaderLabels(["Day", "Subject", "Location", "Time"," ",""]) 
    ...
    def _create_thuseday_table(self): 
        ...
        self.thuseday_table.setHorizontalHeaderLabels(["Day", "Subject", "Location", "Time"," ",""]) 
    ...
    def _create_we_table(self): 
        ...
        self.we_table.setHorizontalHeaderLabels(["Day", "Subject", "Location", "Time"," ",""]) 
    ...
    def _create_th_table(self): 
        ...
        self.th_table.setHorizontalHeaderLabels(["Day", "Subject", "Location", "Time"," ",""]) 
    ...
    def _create_fr_table(self): 
        ...
        self.fr_table.setHorizontalHeaderLabels(["Day", "Subject", "Location", "Time"," ",""]) 
    ...
    def _create_sa_table(self):  
        ...
        self.sa_table.setHorizontalHeaderLabels(["Day", "Subject", "Location", "Time"," ",""]) 
    ...
    def _update_monday_table(self): 
        self.cursor.execute("SELECT day, subject,room_numb, start_time FROM timetable WHERE day='понедельник'") 
    ...
    def _update_thuseday_table(self): 
        self.cursor.execute("SELECT day, subject,room_numb, start_time FROM timetable WHERE day='вторник'") 
        ...
        for i, r in enumerate(records): 
            ...
            joinButton = QPushButton("Join") 
            self.thuseday_table.setCellWidget(i, 4, joinButton) 
            deleteButton = QPushButton("Delete") 
            self.thuseday_table.setCellWidget(i, 5, deleteButton) 
        ...
        addButton = QPushButton("Add") 
        self.thuseday_table.setCellWidget(i+1, 4, addButton) 
    ...
    def _update_we_table(self): 
        self.cursor.execute("SELECT day, subject,room_numb, start_time FROM timetable WHERE day='среда'") 
        ...
        for i, r in enumerate(records): 
            ...
            joinButton = QPushButton("Join") 
            self.we_table.setCellWidget(i, 4, joinButton)
            deleteButton = QPushButton("Delete") 
            self.we_table.setCellWidget(i, 5, deleteButton) 
        ...
        addButton = QPushButton("Add") 
        self.we_table.setCellWidget(i+1, 4, addButton) 
    ...
    def _update_th_table(self): 
        self.cursor.execute("SELECT day, subject,room_numb, start_time FROM timetable WHERE day='четверг'") 
        ...
        for i, r in enumerate(records): 
            ...
            joinButton = QPushButton("Join") 
            self.th_table.setCellWidget(i, 4, joinButton) 
            deleteButton = QPushButton("Delete") 
            self.th_table.setCellWidget(i, 5, deleteButton) 
        ...
        addButton = QPushButton("Add") 
        self.th_table.setCellWidget(i+1, 4, addButton) 
    ...
    def _update_fr_table(self): 
        self.cursor.execute("SELECT day, subject,room_numb, start_time FROM timetable WHERE day='пятница'") 
        ...
        for i, r in enumerate(records): 
            ...
            joinButton = QPushButton("Join") 
            self.fr_table.setCellWidget(i, 4, joinButton) 
            deleteButton = QPushButton("Delete") 
            self.fr_table.setCellWidget(i, 5, deleteButton) 
        ...
        addButton = QPushButton("Add") 
        self.fr_table.setCellWidget(i+1, 4, addButton) 
    ...
    def _update_sa_table(self): 
        self.cursor.execute("SELECT day, subject,room_numb, start_time FROM timetable WHERE day='суббота'") 
        ...
        for i, r in enumerate(records): 
            ...
            joinButton = QPushButton("Join") 
            self.sa_table.setCellWidget(i, 4, joinButton) 
            deleteButton = QPushButton("Delete") 
            self.sa_table.setCellWidget(i, 5, deleteButton) 
    ...
    def _update_teacher_table(self): 
        ...
        addButton = QPushButton("Add") 
        self.teacher_table.setCellWidget(i+1, 2, addButton) 
    ...
    def _change_sub_from_table(self, rowNumb):  
        ...
        for i in range(self.sub_table.columnCount()):  
            try:  
                ...
                row.append(None)  
        try:
            self.cursor.execute("UPDATE subject SET name=%s WHERE id=%s",(str(row[1]),int(row[0])))
            self.conn.commit()  
        except:
            QMessageBox.about(self, "Error", "Enter all fields")  
    ...
    def _delete_timetable_from_table(self, rowNumb, table):  
        ...
        print(row)
        try:
            self.cursor.execute("DELETE FROM timetable WHERE day=%s AND subject=%s AND room_numb=%s AND start_time=%s",(str(row[0]),str(row[1]),str(row[2]),str(row[3])))
            self.conn.commit()  
        except:
            QMessageBox.about(self, "Error", "Enter all fields")  
    ...
    def _delete_teacher_from_table(self, rowNumb):  
        ...
        print(row)
        try:
            self.cursor.execute("DELETE FROM teacher WHERE full_name=%s AND subject=%s",(str(row[0]),str(row[1])))
            self.conn.commit()  
        except:
            QMessageBox.about(self, "Error", "Enter all fields")  
    ...
    def _add_timetable_table(self, rowNumb, table):
        ...
        print(id, row) 
        try:
            self.cursor.execute("INSERT INTO timetable (id, day, subject, room_numb, start_time) VALUES (%s, %s, %s, %s, %s)",(int(id)+1,str(row[0]),str(row[1]),str(row[2]),str(row[3])))
            self.conn.commit()  
        except:
            QMessageBox.about(self, "Error", "Enter all fields")  
    ...
    def _add_teacher_table(self, rowNumb):
        ...
        print(id, row) 
        try:
            self.cursor.execute("INSERT INTO teacher (id, full_name, subject) VALUES (%s, %s, %s)",(int(id)+1,str(row[0]),str(row[1])))
            self.conn.commit()  
        except:
            QMessageBox.about(self, "Error", "Enter all fields")  
